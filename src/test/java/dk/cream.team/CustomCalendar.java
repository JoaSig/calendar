 ...
 * Date: 04/04/13
 */
public class CustomCalendar extends PdfBoxCalendar {
...
//        Locale locale = new Locale(LANGUAGE);
        new CustomCalendar().createCalendar(RESULT);
//        new CustomCalendar().createCalendar(RESULT2, locale, YEAR);
     ...
     * @throws java.io.IOException
     */
    public CustomCalendar() throws DocumentException, IOException {
        super();
...
//        createCalendarWithDateMap(document, writer);
    ...
    private void createCalendarFromEventMap(Document document) throws IOException, ParserException, DocumentException {
        ...
        for (Integer intDay : intDays) {
            ...
            java.util.Date startDate = event.getStartDate().getDate();
            java.util.Date endDate = event.getEndDate().getDate();
